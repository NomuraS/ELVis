...
// change events
var $INPUT_CHECK_KRIPKE = document.querySelector('input[name="check_kripke"]'); // straight arrow
var $INPUT_CHECK_KRIPKE2 = document.querySelector('input[name="check_kripke2"]'); // invisible arrows
...
Rx.DOM.ready().subscribe(function () {
    ...
    var _initialAM = Kr.graph2kripkeObject(_name_kripke, Kr.NODES, Kr.EDGES); // (I). setting for the graph
...
Rx.Observable.fromEvent($BUTTON_ADD_KRIPKE, 'click')
    ...
    var _fromInfo = $(".classOfPrecondition_kripke > .color_text_panel_kripke"); //e0 
    var _toInfo = $(".classOfPrecondition_kripke > .precondition4state_kripke"); //top
