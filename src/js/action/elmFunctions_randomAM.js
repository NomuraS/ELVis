...
var Elm = {};
Elm['ElmFunctions_randomAM'] = Elm['ElmFunctions_randomAM'] || {};
if (typeof _user$project$ElmFunctions_randomAM$main !== 'undefined') {
    _user$project$ElmFunctions_randomAM$main(Elm['ElmFunctions_randomAM'], 'ElmFunctions_randomAM', undefined);
}
