...
var Elm = {};
Elm['ElmFunctions_action'] = Elm['ElmFunctions_action'] || {};
if (typeof _user$project$ElmFunctions_action$main !== 'undefined') {
    _user$project$ElmFunctions_action$main(Elm['ElmFunctions_action'], 'ElmFunctions_action', undefined);
}
